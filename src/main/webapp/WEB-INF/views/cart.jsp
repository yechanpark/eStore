		...
		<section class="container" ng-app="cartApp">
			...
			<div ng-controller="cartCtrl" ng-init="initCartId('${cartId}')">
				...
				<table class="table table-hover">
					...
					<!-- cart객체는  nginit="initCartId('${cartId}')"에 의해 controller.js에서 수행된 initCartId()가 수행된 후
						 refreshCart()가 수행되면서 $scope을 통해 넘어온 것이다. -->
					<!-- 태그 내부를 루프를 돌면서 $scope안에 있는 cart객체의 cartItems 사이즈만큼 돌면서 변수 item에 값을 넣는다. -->
